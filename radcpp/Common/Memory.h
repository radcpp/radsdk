...
// https://github.com/bruxisma/retain-ptr
...
namespace sg14 {
    ...
    public:
        ...
        retain_ptr(pointer ptr, adopt_object_t) : m_ptr{ ptr } { }
...
template <class T>
using RefCountedThreadSafe = sg14::atomic_reference_count<T>;
template <class T>
using RefCounted = sg14::reference_count<T>;

template <class T, class R = sg14::retain_traits<T>>
using Ref = sg14::retain_ptr<T, R>;
